...
public:
  ...
  execution_status read_b_row_from_file_to_arr (size_t global_b_row_index, size_t &size,
                                          double *arr, FILE *fp);
  ...
  void get_block_view (block_view &b, size_t local_r_index, size_t c_index);
  void set_block (block &b, size_t local_r_index, size_t c_index);
